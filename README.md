...
Data analytics project focused on marketing campaign performance, generating business insights from paid media data. Data was extracted from real Meta Ads campaigns, processed using a **Medallion architecture (Bronze → Silver → Gold)** and visualized in Power BI.
